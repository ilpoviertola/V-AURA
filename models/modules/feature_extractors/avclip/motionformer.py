"From https://github.com/v-iashin/Synchformer"
...
def check_if_file_exists_else_download(path, fname2link, chunk_size=1024):
...
class MotionFormer(VisionTransformer):
    ...
    def __init__(
        ...
        agg_space_module: str = "TransformerEncoderLayer",
        agg_time_module: str = "torch.nn.Identity",
        add_global_repr: bool = False,
